...
<table border="1">
	<tr>
		...
		<td align="center" width="40" style="background-color: {{ get_warna_sekunder() }}; color: {{ get_warna_primer() }};"><strong>Instansi</strong></td>
		<td align="center" width="30" style="background-color: {{ get_warna_sekunder() }}; color: {{ get_warna_primer() }};"><strong>Jurusan</strong></td>
		<td align="center" width="30" style="background-color: {{ get_warna_sekunder() }}; color: {{ get_warna_primer() }};"><strong>Kelas</strong></td>
		<td align="center" width="30" style="background-color: {{ get_warna_sekunder() }}; color: {{ get_warna_primer() }};"><strong>Waktu Absensi</strong></td>
	</tr>
