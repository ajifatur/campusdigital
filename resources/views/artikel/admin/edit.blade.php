                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control {{ $errors->has('judul_artikel') ? 'is-invalid' : '' }}" value="{{ $blog->blog_title }}" placeholder="Masukkan Judul artikel">
                                ...
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="{{ $blog->blog_gambar != '' ? asset('assets/images/blog/'.$blog->blog_gambar) : '' }}" class="mt-2 img-thumbnail {{ $blog->blog_gambar != '' ? '' : 'd-none' }}" style="max-height: 150px">
									<input type="hidden" name="gambar" id="src-img">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Tag</label>
                                    <br>
                                    <input type="text" name="tag" data-role="tagsinput" class="form-control {{ $errors->has('tag') ? 'is-invalid' : '' }}" value="{{ $blog->blog_tag }}" placeholder="Masukkan Tag">
                                    @if($errors->has('tag'))
