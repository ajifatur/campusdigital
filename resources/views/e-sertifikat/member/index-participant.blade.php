                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
										<td>
                                            <a href="/member/pelatihan/detail/{{ $data->id_pelatihan }}">{{ $data->pelatihan->nama_pelatihan }}</a>
                                            <br>
										...
										<td>
											<a class="btn btn-primary btn-sm btn-block" href="/member/e-sertifikat/peserta/detail/{{ $data->id_pm }}?page=all" target="_blank"><i class="fa fa-file-pdf mr-2"></i>Cetak</a>
										</td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
