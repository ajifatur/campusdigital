     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Tambah Tools</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Tools</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mx-md-auto">
                        <div class="card shadow">
                            <h5 class="card-title border-bottom">Tambah Tools</h5>
                            <div class="card-body">
                                <form id="form" method="post" action="/admin/file-manager/{{ generate_permalink($kategori->folder_kategori) }}/store" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>File</label>
                                            <br>
                                            <input type="file" id="file-tools" class="d-none" accept="">
                                            <button class="btn btn-sm btn-primary btn-file-tools"><i class="fa fa-folder-open mr-2"></i>Pilih File...</button>
...
<script type="text/javascript">
    /* Upload File */
    $(document).on("click", ".btn-file-tools", function(e){
        e.preventDefault();
        $("#file-tools").trigger("click");
    });
    ...
    function uploadFile(){
        ...
        ajax.open("POST", "/admin/file-manager/{{ generate_permalink($kategori->folder_kategori) }}/upload-tools", true);
        ajax.send(formdata);
    }
