                        ...
                        <form id="form" method="post" action="/admin/file-manager/{{ generate_permalink($kategori->folder_kategori) }}/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="file_nama" class="form-control {{ $errors->has('file_nama') ? 'is-invalid' : '' }}" value="{{ $file->file_nama }}" placeholder="Masukkan Judul Script">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="file_konten" class="form-control {{ $errors->has('file_konten') ? 'is-invalid' : '' }}" rows="10" placeholder="Masukkan Script">{{ $file->file_konten }}</textarea>
