                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_fitur" class="form-control {{ $errors->has('nama_fitur') ? 'is-invalid' : '' }}" value="{{ old('nama_fitur') }}" placeholder="Masukkan Nama Fitur">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="keterangan_fitur" class="form-control {{ $errors->has('keterangan_fitur') ? 'is-invalid' : '' }}" placeholder="Masukkan Keterangan Fitur">{{ old('keterangan_fitur') }}</textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="url_fitur" class="form-control {{ $errors->has('url_fitur') ? 'border-danger' : '' }}" value="{{ old('url_fitur') }}" placeholder="Masukkan URL">
                                    </div>
