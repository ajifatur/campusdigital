                                    ...
                                    <tr>
                                        ...
                                        <td>
											@if($data->komisi_at != null)
                                                ...
                                                <br>
                                                <small><i class="fa fa-clock mr-2"></i>{{ date('H:i', strtotime($data->komisi_at)) }} WIB</small>
											@else
											-
											@endif
                                        </td>
                                        ...
                                        <td>
                                            <a href="/admin/user/detail/{{ $data->id_sponsor->id_user }}">{{ $data->id_sponsor->nama_user }}</a>
                                            <br>
                                            <small><i class="fa fa-envelope mr-2"></i>{{ $data->id_sponsor->email }}</small>
                                            <br>
                                            <small><i class="fa fa-phone mr-2"></i>{{ $data->id_sponsor->nomor_hp }}</small>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                @if($data->komisi_proof != '')
                                                    <a href="#" class="btn btn-sm btn-primary btn-verify" data-id="{{ $data->id_komisi }}" data-proof="{{ asset('assets/images/komisi/'.$data->komisi_proof) }}" data-toggle="tooltip" title="Verifikasi Pembayaran"><i class="fa fa-check"></i></a>
                                                @else
                                        ...
                                        <td align="center">
                                            @if($data->komisi_proof != '')
                                                <a href="{{ asset('assets/images/komisi/'.$data->komisi_proof) }}" class="btn btn-sm btn-primary btn-magnify-popup" data-toggle="tooltip" title="Bukti Transfer"><i class="fa fa-image"></i></a>
                                            @else
                                                <!--<strong class="text-danger"><i class="fa fa-times"></i></strong>-->
                                                <a href="#" class="btn btn-sm btn-primary btn-confirm" data-id="{{ $data->id_komisi }}" data-toggle="tooltip" title="Konfirmasi Pembayaran"><i class="fa fa-check"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
