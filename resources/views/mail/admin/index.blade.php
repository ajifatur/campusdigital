     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Data E-Mail</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                            <li class="breadcrumb-item"><a href="/admin/email">E-Mail</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Data E-Mail</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-title border-bottom">
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                                <h5 class="mb-0">Data E-Mail</h5>
                            </div>
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/email/create" class="btn btn-sm btn-primary"><i class="fa fa-pencil-alt mr-2"></i> Tulis Pesan</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><a href="/admin/email/detail/{{ $data->id_email }}">{{ $data->subject }}</a></td>
                                        <td><a href="/admin/user/detail/{{ $data->id_user }}">{{ $data->nama_user }}</a><br><small>{{ $data->email }}</small></td>
                                        <td><span title="{{ date('d/m/Y H:i:s', strtotime($data->sent_at)) }}" style="text-decoration: underline; cursor: help;">{{ date('d/m/Y', strtotime($data->sent_at)) }}</span></td>
                            ...
                            <form id="form" class="d-none" method="post" action="/admin/email/delete">
                                {{ csrf_field() }}
