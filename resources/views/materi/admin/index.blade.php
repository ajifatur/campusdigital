							...
							<table id="table-produk" class="table table-hover table-bordered">
								...
								<tbody>
									...
									<tr class="data-folder" data-id="{{ $folder->id_folder }}">
                                        ...
                                        <td>
											<span title="{{ date('d/m/Y H:i:s', strtotime($folder->modified_at)) }}" style="text-decoration: underline; cursor: help;">
												{{ date('d/m/Y', strtotime($folder->modified_at)) }}
											</span>
										</td>
                                        @if(Auth::user()->role == role_it() || Auth::user()->role == role_manajer() || Auth::user()->role == role_mentor())
										<td>
									...
									<tr class="data-file" data-id="{{ $file->id_file }}">
                                        ...
                                        <td>
											<span title="{{ date('d/m/Y H:i:s', strtotime($file->uploaded_at)) }}" style="text-decoration: underline; cursor: help;">
