        ...
        <div class="row">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="card shadow">
                    <form id="form" method="post" action="/admin/konten-web/mentor/update" enctype="multipart/form-data">
                        <div class="card-body">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_mentor" class="form-control {{ $errors->has('nama_mentor') ? 'is-invalid' : '' }}" value="{{ $mentor->nama_mentor }}" placeholder="Masukkan Nama Mentor">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="bidang_mentor" class="form-control {{ $errors->has('bidang_mentor') ? 'is-invalid' : '' }}" value="{{ $mentor->bidang_mentor }}" placeholder="Masukkan Bidang Mentor">
                                ...
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="{{ $mentor->foto_mentor != '' ? asset('assets/images/mentor/'.$mentor->foto_mentor) : '' }}" class="mt-2 img-thumbnail {{ $mentor->foto_mentor != '' ? '' : 'd-none' }}" style="max-height: 150px">
