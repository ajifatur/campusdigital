                    ...
                    <form id="form" method="post" action="/admin/pop-up/store" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" name="tipe" id="inlineRadio1" value="1" {{ old('tipe') == 1 || old('tipe') == null ? 'checked' : '' }}>
												<label class="form-check-label" for="inlineRadio1">Gambar</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" name="tipe" id="inlineRadio2" value="2" {{ old('tipe') == 2 ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-12 {{ old('tipe') == 1 || old('tipe') == null ? '' : 'd-none' }}" id="input-gambar">
                                ...
                                <div class="form-group col-md-12 {{ old('tipe') == 2 ? '' : 'd-none' }}" id="input-video">
									<div class="row">
										<div class="col-md-6">
											<label>URL Video <span class="text-danger">*</span></label>
											<input type="text" name="video" class="form-control {{ $errors->has('video') ? 'is-invalid' : '' }}" placeholder="Masukkan URL Video" value="{{ old('video') }}">
											@if($errors->has('video'))
