        ...
        <div class="row">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="card shadow">
                    <form id="form" method="post" action="/admin/artikel/tag/store" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="tag" class="form-control {{ $errors->has('tag') ? 'is-invalid' : '' }}" value="{{ old('tag') }}" placeholder="Masukkan Tag">
                                    @if($errors->has('tag'))
