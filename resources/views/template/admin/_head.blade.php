    ...
    <!-- Custom CSS -->
    <link href="{{ asset('templates/matrix-admin/assets/libs/flot/css/float-chart.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('templates/matrix-admin/dist/css/style.min.css') }}" rel="stylesheet">
    <!-- DataTables -->
