                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Profil Member</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-cyan shadow">
                            <div class="card-body text-center">
                                <h4>URL Referral</h4>
                                <p class="mb-0 h4"><a class="text-light font-weight-bold" href="{{ URL::to('/') }}?ref={{ $user->username }}" target="_blank">{{ URL::to('/') }}?ref={{ $user->username }}</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-warning shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="mb-0 h4 font-weight-bold {{ $user->saldo >= get_min_withdrawal() ? 'text-primary' : 'text-danger' }}">Rp. {{ number_format($user->saldo,0,',','.') }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Status:</label>
                                        <div><strong class="{{ $user->status == 1 ? 'text-success' : 'text-danger' }}">{{ $user->status == 1 ? 'Aktif' : 'Tidak Aktif' }}</strong></div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Sponsor:</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Refer:</label>
                                        <div>{{ count($refer) }} orang <strong class="text-primary">({{ count($refer_aktif) }} aktif)</strong></div>
                                    </div>
                                    <div class="form-group col-md-12">
...
<div class="modal fade" id="modalGaleri" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-choose-photo" class="d-none" method="post" action="/admin/user/choose-photo">
                {{ csrf_field() }}
