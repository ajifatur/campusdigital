                            ...
                            <table id="table-history-withdrawal" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span title="{{ date('d/m/Y H:i:s', strtotime($data->withdrawal_success_at)) }}" style="text-decoration: underline; cursor: help;">{{ date('d/m/Y', strtotime($data->withdrawal_success_at)) }}</span></td>
